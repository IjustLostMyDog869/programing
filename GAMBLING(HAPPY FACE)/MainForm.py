...
class MainForm(Form):
    ...
    def InitializeComponent(self):
					...
					resources = System.Resources.ResourceManager("GAMBLING_HAPPY_FACE_.MainForm", System.Reflection.Assembly.GetEntryAssembly())
    ...
    def Button2Click(self, sender, e):
        rnd = System.Random()
        money = rnd.Next(1, 2000000)
        if money > 2500000000000000000000000000000000:
